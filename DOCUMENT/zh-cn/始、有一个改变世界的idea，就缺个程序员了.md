...
#### 本章知识点
1. [需求的产生和整理](#requirement)
2. [可行性调研分析](#enable)
3. [围绕需求进行系统架构与技术选型](#system)
4. [项目流程及开发规划](#plan)
5. [系统架构图](#chart)
---

#### <span id ="requirement">需求的产生</span>
...
#### <span id="system">围绕目标需求进行系统设计和技术选型</span>
